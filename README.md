<div align="center">
	...
	<h1>Lad In The Window (LITW)<h5>Version: 1.7.1</h5></h1>
...
> Does need require pthreads on Linux/macOS

#### Prerequisites
*   **Windows:** MSVC (Visual Studio) or MinGW
*   **Linux/macOS:** GCC or Clang
*   **Build System:** CMake (3.10 or higher)
*   Terminal that supports 24-bit color, SGR mouse tracking and nerd fonts

> ie [Windows Terminal](https://github.com/microsoft/terminal), [Alacritty](https://github.com/alacritty/alacritty), [kitty](https://github.com/kovidgoyal/kitty), etc...
...
| Mouse                             | Left Click On Widget           | Presses enter on widget       |
...
| Large Text Input Widgets(command) | Enter                          | Confirm input / finish typing |
|                                   | H                              | Move left                     |
|                                   | J                              | Move down                     |
|                                   | K                              | Move up                       |
|                                   | L                              | Move right                    |
| Large Text Input Widgets(input)   | Type while focused             | Add characters                |
|                                   | Enter                          | New line                      |
|                                   | Backspace                      | Remove characters             |
|                                   | Escape                         | Command mode                  |
| Large Text Input Widgets          | Enter                          | Confirm input / finish typing |
